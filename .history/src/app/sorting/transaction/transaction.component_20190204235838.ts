  ...
  save() {
    ...
    this.list.forEach(p => {
      transactionlst.push({
        ...
        Shipments_Id: p.ID,
        DeliveryStatus: p.Transaction.DeliveryStatus,
        DeliveryStatuses_Id: p.Transaction.DeliveryStatus ? p.Transaction.DeliveryStatus.ID : 0,
        IDTypes_Id: p.Transaction.IDType ? p.Transaction.IDType.ID : 0,
