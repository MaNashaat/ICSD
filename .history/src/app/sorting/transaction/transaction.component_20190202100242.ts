...
export class TransactionComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.item = { ID: 0, TransactionDt: this.formatDate(new Date()), Courier: null };
    ...
    /* this.transSC.Courier = this.transSC.Courier == null ? [] : [this.transSC.Courier];
    this.transSC.Customers = this.transSC.Customers == null ? [] : [this.transSC.Customers]; */
