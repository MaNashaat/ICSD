...
export class TransactionComponent implements OnInit, OnDestroy {
  ...
  set selectedCourier(val: Customer) {
    if (!val) {
      this.transSC.Courier = val;
    }
  }
  get selectedCourier() {
    return this.transSC.Courier;
  }

  set selectedCustomer(val: Customer[]) {
    if (!val) {
      this.transSC.Customers = val;
    }
  }
  get selectedCustomer() {
    return this.transSC.Customers;
  }
