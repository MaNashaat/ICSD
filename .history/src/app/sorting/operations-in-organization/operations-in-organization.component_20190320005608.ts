...
export class OperationsInOrganizationComponent implements OnInit {
  ...
  item = {};
  list: any;
  constructor(private content: ElementRef,private translate: TranslateService, private serviceApi: OperationsInOrganizationService, private patterns: PatternsService) {
