...
export class ShipmentComponent implements OnInit, OnDestroy {
  ...
  get ShipmentDate() {
    const day = this.item.ShipmentDt == null ? null : new Date(this.item.ShipmentDt).getDate();
    const month = this.item.ShipmentDt == null ? null : +new Date(this.item.ShipmentDt).getMonth() + 1;
    const year = this.item.ShipmentDt == null ? null : new Date(this.item.ShipmentDt).getFullYear();
