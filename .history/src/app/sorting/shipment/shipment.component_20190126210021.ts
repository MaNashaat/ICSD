...
export class ShipmentComponent implements OnInit, OnDestroy {
  ...
  get ShipmentDate() {
    ...
    const day = this.item.ShipmentDt.getUTCDate();
    const month = this.item.ShipmentDt.getUTCMonth() + 1;
    const year = this.item.ShipmentDt.getUTCFullYear();
