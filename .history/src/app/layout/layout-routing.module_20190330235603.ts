...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'deliveries-and-returns', loadChildren: '../operatoin/deliveries-and-returns/deliveries-and-returns.module#DeliveriesAndReturnsModule'}
      ,
      { path: 'inquiry', loadChildren: '../operatoin/inquiry/inquiry.module#InquiryModule'},
      { path: 'AddInfoToShipmentService', loadChildren: '../operatoin/add-info-to-shipment/add-info-to-shipment.module#AddInfoToShipmentModule'},
      { path: 'operations', loadChildren: '../operatoin/operations-in-organization/operations-in-organization.module#OperationsInOrganizationModule'},
